        ...
        public static void Main()
        {
            ...
            try
            {
                ...
                if (localServerListeningAddress == null)
                {
                    ...
                    localServerListeningAddress = myCallbackUri.GetLeftPart(UriPartial.Authority);
                }

                // Start OWIN host
                using (WebApp.Start<Startup>(url: localServerListeningAddress))
                {
                    sample.RunAsync(myCallbackUri).Wait();
                }
            }
